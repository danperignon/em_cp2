...
export class FilesystemIntegration {
     ...
     */
    async initializeFilesystemConnection() {
        try {
     ...
     */
    async generateReasoningArtifacts(reasoningState, options = {}) {
        if (!this.isAvailable) {
     ...
     */
    async createWorkspace(reasoningState) {
     ...
     * Generate solution overview markdown
     */
    async generateSolutionOverview(reasoningState, workspacePath) {
     ...
     */
    async generateStepByStepGuide(reasoningState, workspacePath) {
     ...
     */
    async generateJSONExport(reasoningState, workspacePath) {
     ...
     */
    async generateReusableTemplate(reasoningState, workspacePath) {
     ...
     */
    async generateStepArtifacts(reasoningState, workspacePath) {
        const artifacts = [];
    ...
    // Content builders
    buildSolutionOverviewContent(reasoningState) {
...
`;
    ...
    buildStepByStepContent(reasoningState) {
...
`;
    ...
    buildTemplateContent(reasoningState) {
        const problem = reasoningState.problem;
...
`;
    ...
    buildStepContent(step, reasoningState) {
...
`;
    ...
    async saveManifest(manifest, workspacePath) {
    ...
    extractProblemType(problem) {
        ...
        if (description.includes('plan'))
            return 'planning';
        if (description.includes('optimize'))
            return 'optimization';
        return 'general';
    }
    ...
    createEmptyManifest(reasoningStateId) {
        return {
            reasoningStateId,
            workspacePath: '',
            artifacts: [],
...
//# sourceMappingURL=filesystem-integration.js.map